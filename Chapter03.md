...
b）页面16个，16·20=320ms
	原答案：（很迷啊，怎么算的传输时间啊？？）：搜索加旋转等待时间为10毫秒。对于2-KB页面，传输时间约为0.009766毫秒，总共约10.009766毫秒。加载这些页面的32将花费大约320.21毫秒。对于4-KB页面，传输时间加倍到大约0.01953毫秒，因此每页的总时间是10.01953毫秒。加载这些页面的16需要大约160.3125毫秒。使用这样快的磁盘，所有重要的是减少传输的数量（或者连续地将页面放在磁盘上）。
- - - -
